...
let gltf: [String: Any] = ["asset": ["version": "2.0", "generator": "bv-usd-export"], "scene": 0, "scenes": [["nodes": [gNodes.count - 1]]], "nodes": gNodes, "meshes": gMeshes, "skins": skins,
  "materials": gMaterials.isEmpty ? [["name": "warrior", "pbrMetallicRoughness": ["baseColorTexture": ["index": 0], "metallicFactor": 0, "roughnessFactor": 0.9]]] : gMaterials,
  "textures": gTextures.isEmpty ? [["source": 0, "sampler": 0]] : gTextures, "samplers": [["magFilter": 9729, "minFilter": 9987, "wrapS": 10497, "wrapT": 10497]], "images": gImages.isEmpty ? [["uri": texName]] : gImages,
